...
class _CommentsTabState extends State<CommentsTab> {
  ...
  Widget build(BuildContext context) {
    return const TabScaffold(
      ...
      children: [_SupportNoteCard(), _CommentListCard()],
    );
  }
}
                              ...
                              Row(
                                children: [
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      _showDeleteConfirmation(context, comment.idComentario);
                                    },
                                  ),
                                ],
                              ),
...
void _showDeleteConfirmation(BuildContext context, int idComentario) {
  showDialog(
    context: context,
    builder: (context) {
      return AlertDialog(
        ...
        actions: [
          ...
          Consumer<CommentProvider>(
            builder: (context, provider, child) {
              ...
              return TextButton(
                onPressed: () async {
                  final success = await provider.deleteComment(idComentario: idComentario);
